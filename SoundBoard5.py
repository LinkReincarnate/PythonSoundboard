...
#Load the sounds
button00Sound = mixer.Sound('Jet Set Radio/Let Mom Sleep/DrumAndGrunt.wav')
...
button05Sound = mixer.Sound('JSR/WhoaHo.mp3')
...
button09Sound = mixer.Sound('JSR/LoveRiff.mp3')

button10Sound = mixer.Sound('JSR/LoveLoveYou.mp3')
button11Sound = mixer.Sound('JSR/YouLoveLoveMe.mp3')
button12Sound = mixer.Sound('JSR/Funky drum.wav')
button13Sound = mixer.Sound('Jet Set Radio/Let Mom Sleep/WouldYouStopPlayingWithThatRadio.mp3')
button14Sound = mixer.Sound('JSR/DROP.mp3')
button15Sound = mixer.Sound('Jet Set Radio/Let Mom Sleep/Yay.mp3')
...
button20Sound = mixer.Sound('Jet Set Radio/Let Mom Sleep/GetDown.wav')
button21Sound = mixer.Sound('Jet Set Radio/Let Mom Sleep/GetFunky.mp3')
button22Sound = mixer.Sound('Jet Set Radio/Let Mom Sleep/Grunt.mp3')
button23Sound = mixer.Sound('Jet Set Radio/Let Mom Sleep/IntroStab.mp3')
button24Sound = mixer.Sound('Jet Set Radio/Let Mom Sleep/LetsLookAtTheFunk.mp3')
...
button31Sound = mixer.Sound('Jet Set Radio/Let Mom Sleep/SaxSqueal.mp3')
