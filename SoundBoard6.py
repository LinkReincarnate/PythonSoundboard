...
button05Sound = mixer.Sound('Loops/looperman-l-1731707-0111360-eluxelux-lp-piano-trap-chords.wav')
button06Sound = mixer.Sound('Loops/Piano180BPMA.wav')
button07Sound = mixer.Sound('Loops/PIANO2180BPMA.wav')
button08Sound = mixer.Sound('Loops/looperman-l-2852656-0182773-ooo-shit-piano-goodlowe.wav')
button09Sound = mixer.Sound('Loops/TrapMelody90BPMA.wav')

button10Sound = mixer.Sound('Loops/looperman-l-2062287-0158982-hardline-drums.wav')
button11Sound = mixer.Sound('Loops/AstronautDrums90BPMA.wav')
button12Sound = mixer.Sound('Loops/TrapDrum90BPMA.wav')
button13Sound = mixer.Sound('Loops/TrapBells90BPMA.wav')
button14Sound = mixer.Sound('Loops/looperman-l-1789907-0100946-rawxlimits-infinite.wav')
button15Sound = mixer.Sound('Loops/looperman-l-1838216-0165645-soulless.wav')
...
button19Sound = mixer.Sound('Loops/looperman-l-2546940-0165016-peacekeeper-trumpet.wav')

button20Sound = mixer.Sound('Loops/BarrelProofBreaks_Break25_Loop01_90bpm_Drum_90BPM_BANDLAB.wav')
button21Sound = mixer.Sound('Loops/BarrelProofBreaks_Break25_Loop02_90bpm_Drum_90BPM_BANDLAB.wav')
button22Sound = mixer.Sound('Loops/loopazon-1644943602-grimy-clonk.mp3')
button23Sound = mixer.Sound('JSR/rolling drums.wav')
button24Sound = mixer.Sound('Loops/loopazon-1644943646-drums-and-bass-beat.mp3')
button25Sound = mixer.Sound('JSR/DROP.mp3')
...
button31Sound = mixer.Sound('Loops/looperman-l-0643834-0065072-xray731-meek-mill-type-loop.wav')
