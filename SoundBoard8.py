...
#Load the sounds
button00Sound = mixer.Sound('Loops/130BPM/ET_130_C_UKGSnareLoop_4bars_Beats_130BPM_BANDLAB.wav')
button00Sound.set_volume(1)

button01Sound = mixer.Sound('Loops/130BPM/ET_130_C_UKGPercLoop_4bars_Beats_130BPM_BANDLAB.wav')
button02Sound = mixer.Sound('Loops/130BPM/ET_130_C_UKGKickLoop_4bars_Beats_130BPM_BANDLAB.wav')
button03Sound = mixer.Sound('Loops/130BPM/ET_130_C_UKGHatLoop_4bars_Beats_130BPM_BANDLAB.wav')
button04Sound = mixer.Sound('Loops/130BPM/Gold_108_Emin_SynthPad01_4bar_BANDLAB.wav')
button05Sound = mixer.Sound('Loops/130BPM/Gold_108_Emin_LeadPad_4bar_BANDLAB.wav')
button06Sound = mixer.Sound('Loops/130BPM/Gold_108_Emin_SubBass1_4bar_BANDLAB.wav')
button07Sound = mixer.Sound('Loops/130BPM/ts_128_Em_Pad_LoFi_8bars_BANDLAB.wav')
button08Sound = mixer.Sound('Loops/130BPM/Chill03_85_Em_EPChords6_8bar_BANDLAB.wav')
button09Sound = mixer.Sound('Loops/130BPM/Chill04_90_Em_VinylNoise_4bar_Fx_BANDLAB.wav')

button10Sound = mixer.Sound('Loops/130BPM/Chill03_85_Drumloop4_8bar_BANDLAB.wav')
...
button16Sound = mixer.Sound('DubstepDrumKit/dubstep-club-a-hat.mp3')
button17Sound = mixer.Sound('DubstepDrumKit/dubstep-club-a-kick.mp3')
button18Sound = mixer.Sound('DubstepDrumKit/dubstep-club-a-snare.mp3')
...
#toggles sound if looping is true and hold is false
button00IsPlaying = False
button01IsPlaying = False
button02IsPlaying = True
button03IsPlaying = True
button04IsPlaying = True
button05IsPlaying = True
button06IsPlaying = True
button07IsPlaying = True
button08IsPlaying = True
button09IsPlaying = True
button10IsPlaying = True
button11IsPlaying = True
button12IsPlaying = True
button13IsPlaying = True
button14IsPlaying = True
button15IsPlaying = True
button16IsPlaying = True
button17IsPlaying = True
button18IsPlaying = True
button19IsPlaying = True
button20IsPlaying = True
button21IsPlaying = True
button22IsPlaying = True
button23IsPlaying = True
button24IsPlaying = True
button25IsPlaying = True
button26IsPlaying = True
button27IsPlaying = True
button28IsPlaying = True
#button29IsPlaying = True
button30IsPlaying = True
button31IsPlaying = True
button32IsPlaying = True
button33IsPlaying = True
button34IsPlaying = True
button35IsPlaying = True
button36IsPlaying = True
button37IsPlaying = True
button38IsPlaying = True
#button39IsPlaying = True
    ...
    for event in pygame.event.get():
        if event.type == JOYBUTTONDOWN:
            ...
            if event.button == 0 and event.instance_id == 0:
                if button00IsPlaying:
                     button00Sound.stop()
                     button00IsPlaying = False
                else:
                    button00Sound.play(button00NumLoops)
                    button00IsPlaying = True

            if event.button == 1 and event.instance_id == 0:
                if button01IsPlaying:
                     button01Sound.stop()
                     button01IsPlaying = False
                else:
                    button01Sound.play(button00NumLoops)
                    button01IsPlaying = True

            if event.button == 2 and event.instance_id == 0:
                if button02IsPlaying:
                     button02Sound.stop()
                     button02IsPlaying = False
                else:
                    button02Sound.play(button00NumLoops)
                    button02IsPlaying = True
